...
- <img src="https://bernstein.run/favicon.ico" height="14" /> [Bernstein](https://github.com/sipyourdrink-ltd/bernstein) - Multi-agent orchestrator that exposes a first-class MCP server to coordinate 37 CLI coding agents (Claude Code, Codex, Gemini CLI, and more) running in parallel git worktrees, with quality gates and cost tracking.
